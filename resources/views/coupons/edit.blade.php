...
<head>
    ...
    <title>{{ __('Edit coupon') }} - Food&Fit</title>
    <!-- Icon -->
    ...
    <div class="flex h-screen items-center justify-center  mt-10 mb-10">
        <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
          ...
          <div class="flex justify-center">
            <div class="flex">
              <h1 class="text-gray-500 font-bold md:text-2xl text-xl">{{ __('Edit coupon') }}</h1>
            </div>
          </div>
            ...
            @method('PUT')
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                <div class="grid grid-cols-1">
                    ...
                    <input class="py-2 px-3 rounded-lg border-2 border-teal-200 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent" value="{{ $coupon->code }}" type="text" name="code"/>
                  </div>
                  <div class="grid grid-cols-1">
                    <label class="uppercase md:text-sm text-xs text-gray-500 font-semibold">{{ __('Discount') }}</label>
                    <input class="py-2 px-3 rounded-lg border-2 border-teal-200 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent" value="{{ $coupon->amount }}" type="text" name="amount"/>
                  </div>
                  <div class="grid grid-cols-1">
              ...
              <div class="grid grid-cols-1 mt-5 mx-7">
                ...
                <input class="py-2 px-3 rounded-lg border-2 border-teal-200 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent" value="{{ $coupon->description }}" type="text" name="description"/>
              </div>
