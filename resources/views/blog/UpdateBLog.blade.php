...
<div class="container">
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full px-3">
      ...
      <textarea value="{{$blog->description}}" name="description" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-description" type="text-area" placeholder="Description of the new blog here....."></textarea>
        @error('description')
            <small style="color: red;">{{$message}}</small>
          @enderror
    </div>
