...
<head>
    ...
    <title>Editar producto {{ $product->name }} - Food&Fit</title>
    <!-- Icon -->
    ...
    <div class="flex h-screen items-center justify-center  mt-32 mb-32">
        <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
          ...
          <div class="flex justify-center">
            <div class="flex">
              <h1 class="text-gray-500 font-bold md:text-2xl text-xl">Editar Producto</h1>
            </div>
          </div>
            ...
            @method('PUT')
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                <div class="grid grid-cols-1">
                  ...
                  <input class="py-2 px-3 rounded-lg border-2 border-teal-200 mt-1 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent" value="{{ $product->name }}" type="text" name="name" placeholder="Name" />
                </div>
                <div class="grid grid-cols-1">
              ...
              <div class="grid grid-cols-1 mt-5 mx-7">
                <label class="uppercase md:text-sm text-xs text-gray-500 font-semibold">Quatity</label>
